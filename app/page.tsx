...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-[#1a1c1e] text-gray-900 dark:text-white">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-gray-50 via-white to-gray-100/40 dark:from-black dark:via-[#0a0f1a] dark:to-[#001f3f]/40 py-18 md:py-20">
        {/* Subtle tech grid overlay */}
        <div className="absolute inset-0 bg-[linear-gradient(transparent_97%,rgba(0,0,0,0.04)_100%),linear-gradient(90deg,transparent_97%,rgba(0,0,0,0.04)_100%)] dark:bg-[linear-gradient(transparent_97%,rgba(255,255,255,0.04)_100%),linear-gradient(90deg,transparent_97%,rgba(255,255,255,0.04)_100%)] bg-[size:40px_40px] opacity-20"></div>
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-slate-300 max-w-4xl mx-auto mb-10">
